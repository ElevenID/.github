...
Thank you for contributing to an ElevenID open-source project.

1. Open an issue before beginning a large or breaking change.
2. Fork the repository and create a focused branch.
3. Run the repository's documented tests and policy checks.
